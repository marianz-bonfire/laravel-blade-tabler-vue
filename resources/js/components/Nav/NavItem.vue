<template>
    <tag-wrapper :tag="tag" class="nav-item">
        <a v-if="hasSubItems" v-click-out-side="hideDropdown" @click="onClick" :class="className">
            <icon v-if="icon" :icon="icon" :prefix="iconPrefix" />
            {{ label }}
        </a>
        <a v-else v-click-out-side="hideDropdown" :href="to" :class="className">
            <icon v-if="icon" :icon="icon" :prefix="iconPrefix" />
            {{ label }}
        </a>
    ...
    methods: {
        onClick(e) {
            ...
            if (this.hasSubItems) {
                ...
                // Use this when using vue-router
