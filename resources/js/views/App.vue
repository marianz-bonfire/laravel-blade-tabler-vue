<template>
  <site-wrapper>
    <div class="sticky-top">
      <site-navbar-header imageUrl="/static/brand/tabler.svg" @toggle-menu="toggleMenu">
        <site-navbar-notifications />
        <account-dropdown imageUrl="/static/faces/female/25.jpg" />
      </site-navbar-header>
      <site-navbar :collapsed="menuCollapsed">
        ...
        <nav-item to="/interface" icon="box" label="Interface">
          ...
          <dropdown-menu-item to="#/table" label="Table" />
        </nav-item>
        ...
        <nav-item to="/hello" icon="file-text" label="Documentation" />
      </site-navbar>
    </div>
    <slot></slot>
