        ...
        <grid-col lg="6">
          <card>
            ...
            <t-table cards vertical-align="center">
              ...
              <table-body>
                <table-row>
                  <table-cel class="w-1"><avatar image-url="/static/faces/male/9.jpg"/></table-cel>
                ...
                <table-row>
                  <table-cel class="w-1"><avatar image-url="/static/faces/female/1.jpg"/></table-cel>
                ...
                <table-row>
                  <table-cel class="w-1"><avatar image-url="/static/faces/male/4.jpg"/></table-cel>
                ...
                <table-row>
                  <table-cel class="w-1"><avatar image-url="/static/faces/female/11.jpg"/></table-cel>
              ...
              <table-body>
                <table-row>
                  <table-cel class="text-center">
                    <avatar image-url="/static/faces/female/26.jpg" status-color="green"/>
                  </table-cel>
                  <table-cel>
